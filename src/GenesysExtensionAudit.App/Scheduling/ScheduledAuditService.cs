...
public sealed class ScheduledAuditService : IScheduledAuditService
{
    ...
    public async Task<ScheduledTaskInfo> CreateAsync(ScheduledAuditDefinition definition, CancellationToken ct)
    {
        ...
        var profile = new ScheduledAuditProfile
        {
            ...
            RunUserTelephonyAudit = definition.RunUserTelephonyAudit,
            RunQueueServiceabilityAudit = definition.RunQueueServiceabilityAudit,
            RunFlowDependencyAudit = definition.RunFlowDependencyAudit,
            ...
            RunSiteTopologyAudit = definition.RunSiteTopologyAudit,
            RunStaleLicenseAudit = definition.RunStaleLicenseAudit,
            RunLicenseOverProvisioningAudit = definition.RunLicenseOverProvisioningAudit,
            RunRoleGroupOverlapAudit = definition.RunRoleGroupOverlapAudit,
            RunPromptHygieneAudit = definition.RunPromptHygieneAudit,
            RunChangeAdjacencyAudit = definition.RunChangeAdjacencyAudit,
            RunFlappingDetectionAudit = definition.RunFlappingDetectionAudit,
            RunHotSpotAudit = definition.RunHotSpotAudit,
