...
|---|---|---|---|---|---|---|---|---|---|
| `3072` | `3072` | `f9c1d4e5-aaaa-4abc-9001-100000000001` | Profile Owner 01 | profile-owner-01@example.invalid | active | `1bc2d3e4-bbbb-4fed-9002-200000000002` | user | Current Owner 02 | `assign-00001` |
| `4401` | `x4401` | `a0b1c2d3-cccc-4abc-9003-300000000003` | Profile Owner 03 | profile-owner-03@example.invalid | active | `e5f6a7b8-dddd-4cde-9004-400000000004` | station | Reception Desk A | `assign-00002` |
...
Extension `3072` is on **Profile Owner 01**'s profile, but the telephony assignment for that extension points to **Current Owner 02**. This means:
...
Extension `4401` is on **Profile Owner 03**'s profile, but the telephony assignment points to a **station** (`Reception Desk A`). This typically means:
