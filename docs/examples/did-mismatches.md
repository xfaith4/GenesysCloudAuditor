...
|---|---|---|---|---|---|---|---|---|---|
| `+12125550101` | `f7a8b9c0-1111-4abc-9070-aaaaaaaaaaaa` | US-Primary | Unassigned | — | — | — | — | — | `Unassigned` |
| `+12125550142` | `a8b9c0d1-2222-4bcd-9071-bbbbbbbbbbbb` | US-Primary | User | `b9c0d1e2-3333-4cde-9072-cccccccccccc` | Inactive User 01 | inactive-user-01@example.invalid | inactive | — | `InactiveUser` |
| `+12125550175` | `c0d1e2f3-4444-4def-9073-dddddddddddd` | US-Primary | User | `d1e2f3a4-5555-4efg-9074-eeeeeeeeeeee` | Active User 02 | active-user-02@example.invalid | active | — | — |
| `+12125550199` | `e2f3a4b5-6666-4fab-9075-ffffffffffff` | US-Primary | IVR | — | — | — | — | Legacy Holiday IVR | `OrphanedIVR` |
...
`+12125550101` exists in the DID pool but is not assigned to any user or routing entry. The number is provisioned and costing money but doing nothing. Inbound calls to this number will likely reach a default error treatment.

### InactiveUser

`+12125550142` is assigned to **Inactive User 01**, whose account is inactive. Calls to this number will not reach a live agent. If this account was decommissioned, the DID should be reassigned or returned to the pool.

### OrphanedIVR

`+12125550199` is assigned to `Legacy Holiday IVR`, which no longer exists in Architect. Calls to this number will fail routing. The IVR binding must be updated or removed.
